...
> Stable engineering rules for the character Skin subsystem. Optimized for
> AI assistants and new team members — captures only the rules that survive
> upcoming Skin additions and Provider swaps. Temporary experiments, the
> concrete paths of placeholder GLBs, and any unverified Provider call
> snippets deliberately stay in `docs/skins/`.
