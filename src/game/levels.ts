...
function meadow(): Level {
  ...
  return compile({
    ...
    bots: 4,
    platforms: [
      plat("start", 0, 8, 16, 18, 0, P, "checkpoint"),
      plat("path", 0, -8, 12, 16, 0, C),
      plat("step1", 0, -18, 10, 6, 0.28, G),
      plat("land1", 0, -26, 11, 12, 0, C),
      plat("plaza", 0, -40, 12, 14, 0, P, "checkpoint"),
      { ...plat("jelly", 0, -50, 5.2, 6, 0, J, "bounce") },
      plat("landj", 0, -58, 10, 10, 0, C),
      plat("gapA", 0, -66, 9, 8, 0, G),
      plat("final", 0, -76, 14, 12, 0, P, "finish"),
    ],
    movers: [],
    hammers: [],
    spinners: [],
